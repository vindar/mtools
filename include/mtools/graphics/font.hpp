...
namespace mtools
	{
		...
		/* text positioning constants, inherited from box positionning */
		static const int MTOOLS_TEXT_XCENTER = MTOOLS_POS_XCENTER;
		static const int MTOOLS_TEXT_LEFT = MTOOLS_POS_LEFT;
		static const int MTOOLS_TEXT_RIGHT = MTOOLS_POS_RIGHT;
		static const int MTOOLS_TEXT_YCENTER = MTOOLS_POS_YCENTER;
		static const int MTOOLS_TEXT_TOP = MTOOLS_POS_TOP;
		static const int MTOOLS_TEXT_BOTTOM = MTOOLS_POS_BOTTOM;
		static const int MTOOLS_TEXT_TOPLEFT = MTOOLS_POS_TOPLEFT;
		static const int MTOOLS_TEXT_TOPRIGHT = MTOOLS_POS_TOPRIGHT;
		static const int MTOOLS_TEXT_BOTTOMLEFT = MTOOLS_POS_BOTTOMLEFT;
		static const int MTOOLS_TEXT_BOTTOMRIGHT = MTOOLS_POS_BOTTOMRIGHT;
		static const int MTOOLS_TEXT_CENTER = MTOOLS_POS_CENTER;
		static const int MTOOLS_TEXT_CENTERLEFT = MTOOLS_POS_CENTERLEFT;
		static const int MTOOLS_TEXT_CENTERRIGHT = MTOOLS_POS_CENTERRIGHT;
		static const int MTOOLS_TEXT_CENTERTOP = MTOOLS_POS_CENTERTOP;
		static const int MTOOLS_TEXT_CENTERBOTTOM = MTOOLS_POS_CENTERBOTTOM;
