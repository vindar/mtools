...
namespace mtools
{
    ...
    **/
    namespace metaprog
    {
        ...
        typedef struct{ bool a; } yes;          ///< yes result type (sizeof(bool))
        typedef struct{ bool a[2]; } no;        ///< no result type (2*sizeof(bool))
        ...
        {
            template<typename U> static decltype(  ((*(U*)(0)) == (*(U*)(0))) , yes()) test(int); // test the existence comparison with ==
        ...
        /**
         * has_toString::value = true if T has a method which call be called in this way: `T->toString()`.
         *
         * @tparam  T   Generic type parameter.
         **/
        template<typename T> class has_toString
        {
            template<typename U> static decltype((*((U*)0)).toString(), yes()) test(int); // test the existence of the method toString()
            template<typename> static no test(...);                                       // fallback for SFINAE
        public:
            static const bool value = sizeof(test<T>(0)) == sizeof(yes);
        };
        ...
        /**
         * has_to_string::value = true if T has a method which call be called in this way: `T.to_string()`.
         *
         * @tparam  T   Generic type parameter.
         **/
        template<typename T> class has_to_string
        {
            template<typename U> static decltype((*((U*)0)).to_string(), yes()) test(int); // test the existence of the method toString()
            template<typename> static no test(...);                                       // fallback for SFINAE
        public:
            static const bool value = sizeof(test<T>(0)) == sizeof(yes);
        };
        ...
        /**
         * has_getColor::value = true if T has a method which call be called in this way: `T->getColor(V)`.
         *
         * @tparam  T   Generic type parameter.
         **/
        template<typename T,typename V> class has_getColor
        {
            template<typename U> static decltype((*((U*)0)).getColor(*((V*)0)), yes()) test(int); // test the existence of the method getColor(iVec2 )
            template<typename> static no test(...);                                       // fallback for SFINAE
        public:
            static const bool value = sizeof(test<T>(0)) == sizeof(yes);
        };
        ...
        /**
         * has_getImage::value = true if T has a method which call be called in this way: `T->getImage(V,V)`.
         *
         * @tparam  T   Generic type parameter.
         **/
        template<typename T,typename V> class has_getImage
        {
            template<typename U> static decltype((*((U*)0)).getImage((*((V*)0)), (*((V*)0))), yes()) test(int); // test the existence of the method getImage(iVec2 )
            template<typename> static no test(...);                                       // fallback for SFINAE
        public:
            static const bool value = sizeof(test<T>(0)) == sizeof(yes);
        };
        ...
        * 
        * This is taken from boost implementation of GCD/LCM
        **/
