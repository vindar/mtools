...
namespace mtools
{
    ...
    void EdgeSiteImage::_draw_centerNoSite(RGBc coul, Image & im, double kx, double ky) const  
		{  
		im.draw_box(iBox2((int64)(kx * 45), (int64)(kx * 55), (int64)(ky * 45), (int64)(ky * 55),true), coul, false); 
		}
    ...
    void EdgeSiteImage::_draw_rect(double x0, double y0, double x1, double y1, RGBc coul, int direction, Image & im, double kx, double ky)  const
		...
		switch (direction)
			...
			case 0:
				{	// up
				im.draw_box(iBox2((int64)(kx*x0), (int64)(kx*x1), (int64)(ky*y0), (int64)(ky*y1), true), coul, false);
				return;
				}
			case 1:
				{	// down
				im.draw_box(iBox2((int64)(kx*x0), (int64)(kx*x1), (int64)(ky*(100 - y0)), (int64)(ky*(100 - y1)), true), coul, false);
				return;
				}
			case 2:
				{   // left
				im.draw_box(iBox2((int64)(kx*y0), (int64)(kx*y1), (int64)(ky*x0), (int64)(ky*x1), true), coul, false);
				return;
				}
			case 3:
				{  // right
				im.draw_box(iBox2((int64)(kx*(100 - y0)), (int64)(kx*(100 - y1)), (int64)(ky*x0), (int64)(ky*x1), true), coul, false);
				return;
				}
			}
		return;
