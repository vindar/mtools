...
LONGLONG randomseed;                     /* Current random number seed. */
...
/*  triangles are four-byte-aligned and that the `LONGLONG' type is     */
...
#define decode(ptr, otri)                                                     \
  (otri).orient = (int) ((LONGLONG) (ptr) & (LONGLONG) 3l);         \
  (otri).tri = (triangle *)                                                   \
                  ((LONGLONG) (ptr) ^ (LONGLONG) (otri).orient)
...
#define encode(otri)                                                          \
  (triangle) ((LONGLONG) (otri).tri | (LONGLONG) (otri).orient)
...
#define infect(otri)                                                          \
  (otri).tri[6] = (triangle)                                                  \
                    ((LONGLONG) (otri).tri[6] | (LONGLONG) 2l)
...
#define infected(otri)                                                        \
  (((LONGLONG) (otri).tri[6] & (LONGLONG) 2l) != 0l)
...
#define sdecode(sptr, osub)                                                   \
  (osub).ssorient = (int) ((LONGLONG) (sptr) & (LONGLONG) 1l);      \
  (osub).ss = (subseg *)                                                      \
              ((LONGLONG) (sptr) & ~ (LONGLONG) 3l)
...
#define sencode(osub)                                                         \
  (subseg) ((LONGLONG) (osub).ss | (LONGLONG) (osub).ssorient)
...

{
  ...
  if (printvertex == (vertex) NULL)
    ...
    printf("    Origin[%d] = x%llx  (%.12g, %.12g)\n",
           (t->orient + 1) % 3 + 3, (LONGLONG) printvertex,
  ...
  if (printvertex == (vertex) NULL)
    ...
    printf("    Dest  [%d] = x%llx  (%.12g, %.12g)\n",
           (t->orient + 2) % 3 + 3, (LONGLONG) printvertex,
           printvertex[0], printvertex[1]);
  apex(*t, printvertex);
  if (printvertex == (vertex) NULL)
    printf("    Apex  [%d] = NULL\n", t->orient + 3);
    ...
    printf("    Apex  [%d] = x%llx  (%.12g, %.12g)\n",
           t->orient + 3, (LONGLONG) printvertex,
           printvertex[0], printvertex[1]);
...

{
  ...
  printf("subsegment x%llx with orientation %d and mark %d:\n",
         (LONGLONG) s->ss, s->ssorient, mark(*s));
  ...
  if (printvertex == (vertex) NULL)
    ...
    printf("    Origin[%d] = x%llx  (%.12g, %.12g)\n",
           2 + s->ssorient, (LONGLONG) printvertex,
           printvertex[0], printvertex[1]);
  sdest(*s, printvertex);
  if (printvertex == (vertex) NULL)
    printf("    Dest  [%d] = NULL\n", 3 - s->ssorient);
    ...
    printf("    Dest  [%d] = x%llx  (%.12g, %.12g)\n",
           3 - s->ssorient, (LONGLONG) printvertex,
           printvertex[0], printvertex[1]);
  ...
  if (printvertex == (vertex) NULL)
    ...
    printf("    Segment origin[%d] = x%llx  (%.12g, %.12g)\n",
           4 + s->ssorient, (LONGLONG) printvertex,
           printvertex[0], printvertex[1]);
  ...
  if (printvertex == (vertex) NULL)
    ...
    printf("    Segment dest  [%d] = x%llx  (%.12g, %.12g)\n",
           5 - s->ssorient, (LONGLONG) printvertex,
           printvertex[0], printvertex[1]);
}
...

{
  ...
  alignptr = (LONGLONG) (pool->nowblock + 1);
  /* Align the item on an `alignbytes'-byte boundary. */
  pool->nextitem = (VOID *)
    (alignptr + (LONGLONG) pool->alignbytes -
     (alignptr % (LONGLONG) pool->alignbytes));
...

{
  ...
  alignptr = (LONGLONG) (pool->pathblock + 1);
...

{
  ...
  alignptr = (LONGLONG) m->dummytribase;
  m->dummytri = (triangle *)
    (alignptr + (LONGLONG) m->triangles.alignbytes -
     (alignptr % (LONGLONG) m->triangles.alignbytes));
  ...
  if (b->usesegments) {
    ...
    alignptr = (LONGLONG) m->dummysubbase;
    m->dummysub = (subseg *)
      (alignptr + (LONGLONG) m->subsegs.alignbytes -
       (alignptr % (LONGLONG) m->subsegs.alignbytes));
...

{
  ...
  alignptr = (LONGLONG) (getblock + 1);
  foundvertex = (char *) (alignptr + (LONGLONG) m->vertices.alignbytes -
                          (alignptr % (LONGLONG) m->vertices.alignbytes));
...
#ifdef ANSI_DECLARATORS
LONGLONG randomnation(unsigned int choices)
#else /* not ANSI_DECLARATORS */
LONGLONG randomnation(choices)
...

{
  ...
  while (totalsamplesleft > 0) {
    ...
    alignptr = (LONGLONG) (sampleblock + 1);
    firsttri = (char *) (alignptr +
                         (LONGLONG) m->triangles.alignbytes -
                         (alignptr %
                          (LONGLONG) m->triangles.alignbytes));
